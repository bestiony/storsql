...
{   
    ...
    $link = "ProductDetails.php?id=".htmlspecialchars($product['id']);
    $image = "<a href='$link'><img src='".htmlspecialchars($product['photos'][0])."'></a>";
    $title = "<a href='$link'><h4>".substr(htmlspecialchars($product['title']),0,21)."</h4></a>";
    echo "
        <div class='col-5 product-box'>
            ...
            $title
            <p>" . substr(htmlspecialchars($product['top']), 0, 15) . "...</p>
            <div class='rating'>
            ...
            <a class='add_to_cart' href='./microprocesses/cart_add_remove.php?cart=".$cartLink."&id=".htmlspecialchars($product['id'])."'>
